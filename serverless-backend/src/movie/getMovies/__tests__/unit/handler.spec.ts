...
describe("Get Favorites", () => {
    it("should return an message if there are no movies", async () => {
        // Arrange
        ...
        expect(response!.body).toEqual(JSON.stringify({ message: "No movies found" }));
    });

    it("should return a internal server error if retrieving the movies fails", async () => {
        //Arrange
